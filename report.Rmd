---
title: "LAM - Enrichment Analysis Report"
date: "`r Sys.Date()`"
output:
  html_document:
    smart: false
...
Infinium DNA methylation array data.
...
In this case we are using mitch ([Kaspi & Ziemann 2020](https://doi.org/10.1186/s12864-020-06856-9)), 
